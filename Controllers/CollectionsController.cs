...
namespace Cinemate.Controllers
{
    public class CollectionsController : Controller
    {
        ...
        {  
            /* The default behavior of the Index action is to display all the Collections and 
             * to provide the user with the ability to edit/delete
             * 
             * We want to provide the user with all the Collections except the default 'All' Collection 
             * Because I don't want users to be able to interact with it. We don't want that to be 
             * edited/deleted because we want it to be there for our imports
             */
            var defaultCollectionName = _appSettings.CinemateSettings.DefaultCollection.Name;
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Collection collection)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    if (collection.Name == _appSettings.CinemateSettings.DefaultCollection.Name)
                    {
